...
subplot(1,2,2);
hold on;
plot(j_10_t(1:(j_10_i-1)),j_10_qdot(1,1:(j_10_i-1)), 'DisplayName', 'Joint 1 Angle', "Color", "red")
plot(j_10_t(1:(j_10_i-1)),j_10_qdot_des(1,1:(j_10_i-1)), 'DisplayName', 'Joint 1 Angle Des', "Color", "red", 'LineStyle','--')
plot(j_10_t(1:(j_10_i-1)),j_10_qdot(2,1:(j_10_i-1)), 'DisplayName', 'Joint 2 Angle', "Color", "green")
plot(j_10_t(1:(j_10_i-1)),j_10_qdot_des(2,1:(j_10_i-1)), 'DisplayName', 'Joint 2 Angle Des', "Color", "green", 'LineStyle','--')
plot(j_10_t(1:(j_10_i-1)),j_10_qdot(3,1:(j_10_i-1)), 'DisplayName', 'Joint 3 Angle', "Color", "blue")
plot(j_10_t(1:(j_10_i-1)),j_10_qdot_des(3,1:(j_10_i-1)), 'DisplayName', 'Joint 3 Angle Des', "Color", "blue", 'LineStyle','--')
plot(j_10_t(1:(j_10_i-1)),j_10_qdot(4,1:(j_10_i-1)), 'DisplayName', 'Joint 4 Angle', "Color", "black")
plot(j_10_t(1:(j_10_i-1)),j_10_qdot_des(4,1:(j_10_i-1)), 'DisplayName', 'Joint 4 Angle Des', "Color", "black", 'LineStyle','--')
hold off;
xlabel("Time (s)")
...
subplot(1,2,2);
hold on;
plot(j_2_t(1:(j_2_i-1)),j_2_qdot(1,1:(j_2_i-1)), 'DisplayName', 'Joint 1 Angle', "Color", "red")
plot(j_2_t(1:(j_2_i-1)),j_2_qdot_des(1,1:(j_2_i-1)), 'DisplayName', 'Joint 1 Angle Des', "Color", "red", 'LineStyle','--')
plot(j_2_t(1:(j_2_i-1)),j_2_qdot(2,1:(j_2_i-1)), 'DisplayName', 'Joint 2 Angle', "Color", "green")
plot(j_2_t(1:(j_2_i-1)),j_2_qdot_des(2,1:(j_2_i-1)), 'DisplayName', 'Joint 2 Angle Des', "Color", "green", 'LineStyle','--')
plot(j_2_t(1:(j_2_i-1)),j_2_qdot(3,1:(j_2_i-1)), 'DisplayName', 'Joint 3 Angle', "Color", "blue")
plot(j_2_t(1:(j_2_i-1)),j_2_qdot_des(3,1:(j_2_i-1)), 'DisplayName', 'Joint 3 Angle Des', "Color", "blue", 'LineStyle','--')
plot(j_2_t(1:(j_2_i-1)),j_2_qdot(4,1:(j_2_i-1)), 'DisplayName', 'Joint 4 Angle', "Color", "black")
plot(j_2_t(1:(j_2_i-1)),j_2_qdot_des(4,1:(j_2_i-1)), 'DisplayName', 'Joint 4 Angle Des', "Color", "black", 'LineStyle','--')
hold off;
xlabel("Time (s)")
ylabel("Joint Velocity (degree/sec)")
legend
